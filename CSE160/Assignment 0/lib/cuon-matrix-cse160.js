...
class Vector3 {
    ...
    static dot(other1, other2) {
        // Insert your code here.
        var obj1 = other1.elements;
        var obj2 = other2.elements;
        let d = 0;
        for (var i = 0; i < 3; i+=1) {
            d += obj1[i] * obj2[i];
        }
    ...
    static cross(other1, other2) {
        ...
        var obj1 = other1.elements;
        var obj2 = other2.elements;
        v3.elements[0] = (obj1[1] * obj2[2]) - (obj1[2] * obj2[1]);
        v3.elements[1] = -((obj1[0] * obj2[2]) - (obj1[2] * obj2[0]));
        v3.elements[2] = (obj1[0] * obj2[1]) - (obj1[1] * obj2[0]);
        v3[0] = (obj1[1] * obj2[2]) - (obj1[2] * obj2[1]);
        v3[1] = -((obj1[0] * obj2[2]) - (obj1[2] * obj2[0]));
        v3[2] = (obj1[0] * obj2[1]) - (obj1[1] * obj2[0]);
        // Don't delete the return statement.
        return v3;
    }
